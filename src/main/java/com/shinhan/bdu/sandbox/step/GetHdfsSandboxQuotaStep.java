 ...
 *
 */
public class GetHdfsSandboxQuotaStep implements Step<List<Map>, List<Map>> {
	private Map<String, String> config;
	private final Logger logger = LoggerFactory.getLogger(GetHdfsSandboxQuotaStep.class);
	...
	public List<Map> process(List<Map> input) throws StepException {
		...
		logger.info("***  hdfs info (Sandbox Quota) : get " + infoMaps.size() + " item's data");
